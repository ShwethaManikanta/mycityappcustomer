...
import 'package:mycityapp/HotelBooking/widgets/details/hotel_details_bottom.dart';

AnimatedPadding buildHotelDetails(BuildContext context, Map hotel,
  ...
  return AnimatedPadding(
    ...
    child: Column(
      children: [
        ...
        buildDetailsBottomBar(context, hotel, defaultColor, secondColor, size),
      ],
    ),
  );
}
