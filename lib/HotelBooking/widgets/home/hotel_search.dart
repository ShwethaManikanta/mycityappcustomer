...
import 'package:mycityapp/HotelBooking/data/example_data.dart';
import 'package:mycityapp/HotelBooking/widgets/home/hotel.dart';
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            return buildHotel(context, hotel, defaultColor, size);
          },
        ),
      ),
    ),
