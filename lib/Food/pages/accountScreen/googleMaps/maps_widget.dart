...
// for my drawn routes on the map
  ...
  String googleAPIKey = "AIzaSyDmAKO_2HdB8I4hVpTIN3DKYZO5xCXQ2ow";
// for my custom marker pins
  ...
  trackDriverLocation() {
    ...
    //       apiServices
    //           .trackOrder(
    //               orderId: orderHistoryAPIProvider.orderHistoryResponse!
    //                   .orderHistory![int.parse(widget.orderId)].id!)
    //           .then((value) {
    //         print("the location track value" + value!.status.toString());
    //         if (value.status == "1" && value.trackDetails != null) {
    //           updatePinOnMap(
  ...
  Widget build(BuildContext context) {
    ...
    if (orderHistoryAPIProvider.orderHistoryResponseModel!
            .orderOngoing![int.parse(widget.orderId)].status ==
        "1") {
      return Center(
          child: SizedBox(
              height: 200,
    ...
    } else if (orderHistoryAPIProvider.orderHistoryResponseModel!
            .orderOngoing![int.parse(widget.orderId)].status ==
        "2") {
      return Center(
          child: SizedBox(
          ...
          child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Utils.getSizedBox(height: 40),
                  Text(
                    'Yahoo!! Order Completed Successfully! 🥳',
                    style: CommonStyles.black1254thin(),
                  )
                ],
              )));
  ...
  googleMapsBody() {
    ...
    LatLng initialTarget = LatLng(
        double.parse(orderHistoryAPIProvider.orderHistoryResponseModel!
            .orderOngoing![int.parse(widget.orderId)].customerName!.lat!),
        double.parse(orderHistoryAPIProvider.orderHistoryResponseModel!
            .orderOngoing![int.parse(widget.orderId)].customerName!.long!));
    ...
    if (orderHistoryAPIProvider.orderHistoryResponseModel!
      ...
      var pinPosition = LatLng(
          double.parse(orderHistoryAPIProvider
              ...
              .orderOngoing![int.parse(widget.orderId)]
